...
export class ItemComponent implements OnInit {
  ...
  constructor() {
    ...
    this._menuService.resetSource$.pipe(takeUntilDestroyed()).subscribe(() => {
      this.active = false;
    });
  ...
  updateActiveStateFromRoute() {
    this.active = this._router.isActive(
  ...
  itemClick(event: Event) {
    ...
    if (this.item.items) this.active = !this.active;
      ...
      if (
        this._dashboardComponent.isDesktop() &&
        this._dashboardComponent.isOverlay()
      )
